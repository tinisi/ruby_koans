...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # inject iterates to processes the contents of an array with a function that can takes an 
    # arbitrary starting value for the processed result, which is passed in to each "iteration"
